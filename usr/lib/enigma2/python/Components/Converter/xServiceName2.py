# -*- coding: utf-8 -*-
#
# Extended ServiceName Converter for Enigma2 Dreamboxes (xServiceName2.py)
...
class xServiceName2(Converter, object):
        NAME = 0
        NUMBER = 1
        BOUQUET = 2
        PROVIDER = 3
                ...
                while True:
                        ...
                        if f == 't':    # %t - tuner_type (dvb-s/s2/c/t)
                                ...
                                if type == 'DVB-S':
                                        ...
                                        result += {0:'Auto',1:'QPSK',2:'8PSK',3:'QAM16'}.get(x,'')
                    
                                elif type == 'DVB-C':
                                        # result += x in range(6) and {0:'Auto',1:'QAM16',2:'QAM32',3:'QAM64',4:'QAM128',5:'QAM256'}[x] or ''
                                        result += {0:'Auto',1:'QAM16',2:'QAM32',3:'QAM64',4:'QAM128',5:'QAM256'}.get(x,'')
                                ...
                                if type == 'DVB-T':
                                        ...
                                        result += {0:'QPSK',1:'QAM16',2:'QAM64',3:'Auto'}.get(x,'') 
                                ...
                                if type == 'DVB-T':
                                        ...
                                        result += {0:'None',1:'1',2:'2',3:'4',4:'Auto'}.get(x,'')
                        else:
                                result += f
                        if pos+1 >= l: break
                        fmt = fmt[pos+1:]
