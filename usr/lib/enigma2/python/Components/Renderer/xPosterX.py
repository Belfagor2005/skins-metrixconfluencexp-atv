...
# <widget source="ServiceEvent" render="xPosterX" position="820,100" size="100,150" path="/media/hdd/poster/" nexts="2" zPosition="9" />
    ...
    def run(self):
        ...
        while True:
            try:
                ...
                print('xPosterX exceptions', str(e))
        ...
        while True:
            ...
            for f in os.listdir(pathlist):
                ...
                if diff_tm > 259200:  # Detect old files > 3 days old
                    ...
                    os.remove("/tmp/xPosterX.log")  # remove xPosterX > 3 days old
                    oldfd = oldfd + 1
