...
#    
#######################################################################
# <widget source="session.CurrentService" render="Label" borderWidth="2" position="250,86" size="1084,55" font="LCD; 48" valign="center" noWrap="1" backgroundColor="black" transparent="1" foregroundColor="grey" zPosition="-1" halign="left">
...
class xEmptyEpg(VariableText, Renderer):
