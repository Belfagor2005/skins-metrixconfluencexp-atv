            ...
            if what[0] == self.CHANGED_CLEAR:
                ...
                if self.event:
                    ...
                    try:
                        ...
                        eventNm = REGEX.sub("", evName).strip().replace('ё','е')
